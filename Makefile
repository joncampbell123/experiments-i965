all: ds1 ds2 ds3 ds4 ds5 ds6 ds7 ds8 ds9 ring1 ring2 ring3 ring4 ring5 ring6 ring7 ring8 ring9 ring10 ring11 gttfun

INTEL_OBJS=find_intel.o util.o mmap.o intelfbhw.o pgtable.o uvma.o
RINGBUFFER=ringbuffer.o

clean:
	rm -f ds? ring? ring1{0,1} *.o gttfun *~
